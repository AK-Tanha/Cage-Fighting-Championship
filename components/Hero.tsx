...
const Hero: React.FC<{ onNavigate: (v: any) => void }> = ({ onNavigate }) => {
  return (
        ...
        <div className="max-w-2xl">
          ...
          <div className="flex flex-wrap gap-4">
            <button 
                ...
                className="bg-white text-black px-10 py-4 font-oswald font-black uppercase tracking-widest border-2 border-white hover:bg-[#FE0002] hover:border-[#FE0002] hover:text-white transition-all transform hover:scale-105"
            >
              Watch Fight Pass
            </button>
            <button 
                onClick={() => onNavigate('fighters')}
                className="bg-transparent text-white px-10 py-4 font-oswald font-black uppercase tracking-widest border-2 border-white/20 hover:border-[#FE0002] transition-all transform hover:scale-105"
            >
              View Roster
            </button>
          </div>
