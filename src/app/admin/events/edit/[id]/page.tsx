    ...
    const fetchData = async () => {
      ...
      try {
        ...
        setData({
          ...
          fights: eventData.fights?.length ? eventData.fights.map((f: any) => ({
            fighter1: f.fighter1 || "",
            fighter2: f.fighter2 || "",
            referee: f.referee || "",
            ...
            rounds: f.rounds || 3,
            round_time_minutes: f.round_time_minutes || 5,
            is_championship_rounds: !!f.is_championship_rounds,
            result: f.result || "",
            winner_id: f.winner_id || "",
            method: f.method || "",
            round_ended: f.round_ended,
            time_ended: f.time_ended || "",
            order: f.order || 1,
            fight_type: f.fight_type || "Professional",
          })) : [
            {
              fighter1: "",
              fighter2: "",
