...
import { createHeroSlide, uploadImage } from "@/lib/api";
...
const HeroSlideCreate = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await createHeroSlide(data as any);
      setSuccess(true);
      setTimeout(() => {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <h1 className="text-4xl font-display font-black uppercase italic tracking-tighter">
              Create <span className="text-[#FE0002]">Hero Slide</span>
            </h1>
          </div>
        </div>
        ...
        {success && (
          <div className="mb-6 p-4 bg-green-50 border-l-4 border-green-500 text-green-700 font-bold text-sm uppercase tracking-widest">
            Slide created successfully! Redirecting...
          </div>
        )}
