...
import { createJudge, uploadImage } from "@/lib/api";
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            >
              <i className="fa-solid fa-arrow-left text-xs"></i> Back to Judges
            </Link>
            <h1 className="text-2xl md:text-4xl font-display font-black uppercase italic tracking-tighter">
                Create <span className="text-[#FE0002]">Judge</span>
            </h1>
          </div>
        </div>
