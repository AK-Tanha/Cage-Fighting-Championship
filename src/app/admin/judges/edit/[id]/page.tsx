...
import { getJudgeById, updateJudge, uploadImage } from "@/lib/api";
...
const JudgeEditPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await updateJudge(judgeId, data as any);
      setSuccess(true);
      setTimeout(() => {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <h1 className="text-2xl md:text-4xl font-display font-black uppercase italic tracking-tighter">
                Edit <span className="text-[#FE0002]">Judge</span>
            </h1>
          </div>
        </div>
        ...
        {success && (
          <div className="mb-6 p-4 bg-green-50 border-l-4 border-green-500 text-green-700 font-bold text-sm uppercase tracking-widest">
            Judge updated successfully! Redirecting...
          </div>
        )}
            ...
            <div>
              ...
              <div className="flex flex-col">
                ...
                <textarea
                  ...
                  value={data.bio}
                  onChange={handleChange}
                  placeholder="Write a short biography about the judge..."
              ...
              <div className="space-y-4">
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="https://example.com/judge-image.jpg"
                    className="bg-gray-50 border border-black/10 rounded-sm px-4 py-3 focus:outline-none focus:border-[#FE0002] transition-colors font-medium text-sm"
                  />
                </div>
