        ...
        <div className="group relative bg-white border border-black/5 hover:border-[#FE0002]/30 transition-all rounded-sm p-3 md:p-4 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6 shadow-sm">
            ...
            >
                ...
                <div className="w-12 h-12 md:w-14 md:h-14 shrink-0 rounded-none overflow-hidden border border-black/5 group-hover:border-[#FE0002]/30 transition-all bg-gray-50 relative">
                    <Image 
                        src={f1?.image_url || `https://picsum.photos/seed/${f1?._id}/300/300`} 
            ...
            <div className="flex flex-col items-center justify-center shrink-0 min-w-[100px] border-x border-black/5 px-4 h-full">
                <div className="text-2xl font-display font-black italic text-black/10 group-hover:text-[#FE0002]/20 transition-colors">VS</div>
                <p className="text-[8px] font-black uppercase tracking-[0.2em] text-black mb-1">{fight.weight_class}</p>
                
                {/* Referee Badge */}
                <div className="flex flex-col items-center mt-1">
                    <p className="text-[7px] font-black uppercase tracking-widest text-[#FE0002] mb-0.5 opacity-60">Referee</p>
                    <p className="text-[9px] font-bold uppercase tracking-tight text-gray-500 whitespace-nowrap">
                        {fight.referee && referees[fight.referee] ? referees[fight.referee].name : "Pending"}
                    </p>
                </div>

                {fight.title_fight && (
                    <span className="bg-black text-white text-[7px] font-black px-2 py-0.5 rounded-none mt-2 uppercase tracking-widest">TITLE FIGHT</span>
                )}
            </div>
            ...
            >
                <div className="w-12 h-12 md:w-14 md:h-14 shrink-0 rounded-none overflow-hidden border border-black/5 group-hover:border-[#FE0002]/30 transition-all bg-gray-50 relative">
                    <Image 
                        src={f2?.image_url || `https://picsum.photos/seed/${f2?._id}/300/300`} 
                ...
                <div className="flex-1 text-left min-w-0">
                    <h4 className="text-lg md:text-xl font-display font-black uppercase italic truncate">
                        <Link href={`/fighters/${f2?._id}`} className="hover:text-[#FE0002] transition-colors">
...
const EventDetails: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 text-black pb-24">
            ...
            {/* Header Banner Image */}
            <div className="w-full pt-20 relative h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden group">
                <Image
