    ...
    return (
        <footer className="bg-gray-50 py-12 border-t border-black/5">
            <div className="max-w-7xl mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="text-gray-600 text-sm space-y-2">
                            ...
                            <li className="hover:text-black cursor-pointer transition-colors">Fight Pass</li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex gap-4">
                            <a href="https://www.facebook.com/profile.php?id=61569594516700" className="w-10 h-10 flex items-center justify-center bg-black text-white hover:bg-[#FE0002] transition-all rounded-sm">
                                <i className="fa-brands fa-facebook"></i>
                            </a>
                            <a href="#" className="w-10 h-10 flex items-center justify-center bg-black text-white hover:bg-[#FE0002] transition-all rounded-sm">
                ...
                <div className="pt-8 border-t border-black/5 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] text-gray-500 font-bold uppercase tracking-widest">
